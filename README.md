...
Requirements:
	...
	FET is created in the following environment: openSUSE Tumbleweed GNU/Linux distribution, Linux 4.19.11, Xfce 4.12,
	Midnight Commander 4.8.21, KDiff3 0.9.98, Qt 5.12.0, gcc 8.2.1, g++ 8.2.1, make 4.2.1, sed 4.5,
	Valgrind 3.13.0, Coverity Scan 2017.07, Cppcheck 1.86, other great free tools.
	...
	Software:
		...
		Qt 5.12.0 or compatible (The authors also tried to maintain backwards source compatibility with Qt 4.v.v).
...
Getting - compiling - installing Qt:
	...
	You will need Qt 5.12.0 or compatible to compile FET (The authors also tried to maintain backwards source compatibility with Qt 4.v.v).
	...
	(some usual locations are /usr/share/qt5/mkspecs or /usr/lib/qt5/mkspecs on GNU/Linux or C:\Qt\5.12.0\mkspecs on Windows).
...
Compiling FET:
	...
	Currently FET can be compiled with a C++ compiler, using Qt version 5.12.0 or compatible.
	...
	GNU/Linux:
	- You will need Qt 5.12.0 or compatible to compile this program.
	...
	3. Another variant, if you use the Clang C++ compiler (which seems to be the default for Qt 5.12.0 on Mac):
	It seems that you need to type:
	"/Users/Yourname/Qt5.12.0/5.12.0/clang_64/bin/qmake -r -spec /Users/Yourname/Qt5.12.0/5.12.0/clang_64/mkspecs/macx-clang", then "make"
	...
	Windows: MinGW C++ compiler: you need Qt 5.12.0 or compatible, and MinGW.
